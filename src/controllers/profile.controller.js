...
export const updateProfileData = async (req, res) => {
  ...
  if (pacienteFound.direccion === direccion && pacienteFound.email === email && pacienteFound.telefono === telefono) return res.status(404).json({ message: "Se han ingresado los mismos datos:::!!!" });
  ...
  return res.json ({
    ...
    nombre: pacienteFound.nombre_completo,
